...
class Exchange(API):
    ...
    def __init__(
        ...
        self.coin_to_asset = {
            ...
            for (asset, asset_info) in enumerate(self.meta["universe"])
        }
    ...
    def _slippage_price(
        self, coin: str, is_buy: bool, slippage: float, px: Optional[float] = None,
    ) -> float:
    ...
    def bulk_modify_orders_new(self, modify_requests: List[ModifyRequest]) -> Any:
        ...
        modify_wires = [
            {
                ...
                "order": order_request_to_order_wire(
                    modify["order"], self.coin_to_asset[modify["order"]["coin"]]
                ),
            }
        ...
        return self._post_action(modify_action, signature, timestamp,)
    ...
    def bulk_cancel(self, cancel_requests: List[CancelRequest]) -> Any:
        ...
        cancel_action = {
            "type": "cancel",
            "cancels": [
                {"a": self.coin_to_asset[cancel["coin"]], "o": cancel["oid"],}
    ...
    def schedule_cancel(self, time: Optional[int]) -> Any:
        ...
        return self._post_action(schedule_cancel_action, signature, timestamp,)
    ...
    def user_spot_transfer(self, usdc: float, to_perp: bool) -> Any:
        ...
        spot_user_action = {
            "type": "spotUser",
            "classTransfer": {"usdc": usdc, "toPerp": to_perp,},
        }
        signature = sign_l1_action(
            self.wallet,
            spot_user_action,
        ...
        return self._post_action(spot_user_action, signature, timestamp,)
    ...
    def sub_account_transfer(
        ...
        return self._post_action(sub_account_transfer_action, signature, timestamp,)
